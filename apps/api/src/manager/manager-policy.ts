...
const INTERNAL_ACTIONS = new Set(["create_task", "create_conversation_task", "update_conversation_task", "assign_conversation_task", "create_decision", "generate_event_advance", "generate_project_plan", "remember_fact", "assign_task", "update_profile_context", "update_task", "create_goal", "update_goal", "create_initiative", "update_initiative"]);
