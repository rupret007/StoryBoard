...
const INTERNAL_ACTIONS = new Set(["create_task", "create_decision", "generate_event_advance", "generate_project_plan", "update_task", "create_goal", "update_goal", "create_initiative", "update_initiative"]);
