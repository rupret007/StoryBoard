...
function goldenResults(candidateVersion: string): EvalResult[] {
  ...
  return [
    ...
    { name: "empty-seed-setlist-honesty", source: "golden", passed: /no upcoming shows, rehearsals, or other band events/i.test(emptySetlistAnswer.answer) && !/opener|closer|vault|travis|rad dad/i.test(emptySetlistAnswer.answer), detail: "An empty song/event seed does not invent a setlist or Vault catalog." },
