...
export type ManagerRecommendation = { id: string; title: string; reason: string; nextAction: string; priority: string; evidence: string[]; outcome: string; outcomeReason?: string | null; outcomeNote?: string | null; proposedAction?: { type: "create_task"; title: string } | null };
...
export type ManagerMessageAction = { recommendationId: string; title: string; nextAction: string; outcome: string };
export type ManagerMessage = { id: string; role: "user" | "assistant"; content: string; citations: string[]; proposedActions: ManagerMessageAction[]; createdAt: string };
...
export type ManagerLearningSummary = { windowDays: number; total: number; suggested: number; accepted: number; dismissed: number; completed: number; blocked: number; acceptanceRate: number | null; completionRate: number | null; openAcceptedTasks: number; dismissalReasons: { reason: string; count: number }[] };
...
export type BandEvent = { id: string; type: string; status: string; title: string; startsAt?: string | null; endsAt?: string | null; venueId?: string | null; contactId?: string | null; setlistId?: string | null; locationName?: string | null; loadInAt?: string | null; soundcheckAt?: string | null; doorsAt?: string | null; setAt?: string | null; curfewAt?: string | null; productionNotes?: string | null; guaranteeMinor?: number | null; depositMinor?: number | null; currency: string; participants: { id: string; response: string; bandMember: BandMember }[]; tasks?: Task[] };
