...
export type ManagerMessageAction = { recommendationId: string; title: string; nextAction: string; outcome: string; actionType?: "create_task" | "create_conversation_task" | "update_conversation_task" | "assign_conversation_task" | "create_conversation_project" | "create_decision" | "generate_event_advance" | "generate_project_plan" | "remember_fact" | "assign_task" | "update_profile_context" | null; preview?: string };
