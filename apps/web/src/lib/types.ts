...
export type ManagerMessageAction = { recommendationId: string; title: string; nextAction: string; outcome: string; actionType?: "create_task" | "create_conversation_task" | "create_decision" | "generate_event_advance" | "generate_project_plan" | "remember_fact" | "assign_task" | "update_profile_context" | null; preview?: string };
