...
import { Activity, Archive, BrainCircuit, Check, MessageSquareText, Pencil, Plus, RefreshCw, Save, Send, ShieldCheck, Target, ThumbsDown, ThumbsUp, TrendingUp, X } from "lucide-react";
import { useRouter } from "next/navigation";
import { useEffect, useState } from "react";
import { apiFetch } from "@/lib/api";
import type { BandMember, ManagerConversation, ManagerEvalExample, ManagerEvaluationRun, ManagerGoal, ManagerGoalProgressEvent, ManagerLearningSummary, ManagerMemoryFact, ManagerMessage, ManagerMessageFeedback, ManagerOutcomeReview, ManagerPlanHealth, ManagerProfile, ManagerRun } from "@/lib/types";

export function ManagerClient({ initialProfile, initialMembers, initialGoals, initialBrief, initialConversation, initialMemory, initialLearning, initialPlanHealth, initialOutcomeReview, initialEvalExamples, initialEvaluation }: { initialProfile: ManagerProfile | null; initialMembers: BandMember[]; initialGoals: ManagerGoal[]; initialBrief: ManagerRun | null; initialConversation: ManagerConversation | null; initialMemory: ManagerMemoryFact[]; initialLearning: ManagerLearningSummary | null; initialPlanHealth: ManagerPlanHealth | null; initialOutcomeReview: ManagerOutcomeReview | null; initialEvalExamples: ManagerEvalExample[] | null; initialEvaluation: ManagerEvaluationRun | null }) {
