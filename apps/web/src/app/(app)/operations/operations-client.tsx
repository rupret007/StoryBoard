...
function Music({ songs, setlists, events, readiness, busy, create, openWorkspace }: { songs: Song[]; setlists: Setlist[]; events: BandEvent[]; readiness: ShowReadiness[]; busy: boolean; create: Mutate; openWorkspace: OpenWorkspace }) {
  const [title, setTitle] = useState("");
...
function SetlistBuilder({ setlist, songs, attachedEvents, busy, create, openWorkspace }: { setlist: Setlist; songs: Song[]; attachedEvents: BandEvent[]; busy: boolean; create: Mutate; openWorkspace: OpenWorkspace }) {
