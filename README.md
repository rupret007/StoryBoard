...
Prompt/policy version `manager_os_v33` and its `manager_evals_v43` offline eval
...
unit/eval gate: root typecheck/lint, 24/24 shared tests, 269/269 API unit
tests, both production builds, and 97/97 `manager_evals_v43` checks at 100%
