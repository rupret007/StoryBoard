...
Prompt/policy version `manager_os_v33` and its `manager_evals_v42` offline eval
...
unit/eval gate: root typecheck/lint, 24/24 shared tests, 268/268 API unit
tests, both production builds, and 96/96 `manager_evals_v42` checks at 100%
